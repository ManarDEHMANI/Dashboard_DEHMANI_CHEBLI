...
import pandas as pd
from app import app
from components.function import update_map_and_selectors ,update_histogram,update_histogram_superficie
...
years_with_step = list(range(df['annee_mise_en_service'].min(), df['annee_mise_en_service'].max() + 1, 20))
